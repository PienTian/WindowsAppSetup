...
To use some command, you need to restart shell.

If you want to install iTunes, please download from official site.
iTunes on winget repostiory may have an issue relates to dll.

You need to buy subscription to use Microsoft office.
If you don't want to do so, please try LibreOffice. >> winget search libreoffice

Pin Alacritty to taskbar at leftomost is recommended so that you can open terminal with win+T and enter.
"@

echo @"
Now, Alacritty color scheme will be set up. whenever you want, you can download default config file from
...
mkdir C:\Users\$name\AppData\Roaming\alacritty
cd C:\Users\$name\AppData\Roaming\alacritty
New-Item alacritty.yml
...
colors:
 ...
 command:
  ...
  # Bright colors
  bright:
  # black is used as option color such as -a --help
  ## black:   '#666666'
    black:  '#fdff8f'
  # red is used as error message colo
  ##red:     '#d54e53'
    red:  '#d47ae8'
    green:   '#b9ca4a'
  # yellow is used as command color
  ##yellow:  '#e7c547'
    yellow:  '#abece7'
    blue:    '#7aa6da'
    #magenta: '#c397d8'
